  ...
  (function (e, t) {
      ...
      z = {
        ...
        mime: function (e) {
          ...
          e && e.includes("codecs=")
            ...
            : "audio/mpeg" === e
            ? (t = "audio/mpeg;")
            : e in U && (t = "".concat(e, '; codecs="').concat(U[e], '"'));
          try {
    ...
    var ce = {
      ...
      create: function (e) {
        ...
        return (
          ...
          this.isHTML5 &&
            ce.setQualityMenu.call(this, W.getQualityOptions.call(this)),
      ...
      inject: function () {
        ...
        if (
          (window.navigator.userAgent.includes("Edge") && V(o),
    ...
    var Le = {
      ...
      ready: function () {
        ...
        l.appendChild(o),
          (t.media = S(l, t.media)),
          ie(Q(t.config.urls.vimeo.api, s), "json").then(function (e) {
            if (!m.empty(e)) {
